...
#endif
#define __ceil fdlibm__ceil
#define __ceilf fdlibm__ceilf
#define __floor fdlibm__floor
#define __floorf fdlibm__floorf
#define __copysign fdlibm__copysign
#define __copysignf fdlibm__copysignf
#ifndef __isnan
#define __isnan(x) minicrt_isnan_double((double)(x))
#endif
#ifndef __isnanf
#define __isnanf(x) minicrt_isnan_float((float)(x))
#endif
#ifndef __signbit
#define __signbit(x) minicrt_signbit_double((double)(x))
#endif
#ifndef __signbitf
#define __signbitf(x) minicrt_signbit_float((float)(x))
#endif
#ifndef __isnanl
#define __isnanl(x) minicrt_isnan_double((double)(x))
#endif
#ifndef __signbitl
#define __signbitl(x) minicrt_signbit_double((double)(x))
#endif
#endif
...
#define isfinite(x) (sizeof(x) == sizeof(float) ? minicrt_isfinite_float((float)(x)) : minicrt_isfinite_double((double)(x)))
#endif

#ifndef isinf
int minicrt_isinf_double(double x);
int minicrt_isinf_float(float x);
#define isinf(x) (sizeof(x) == sizeof(float) ? minicrt_isinf_float((float)(x)) : minicrt_isinf_double((double)(x)))
#endif

#ifndef isless
int minicrt_isless_double(double x, double y);
int minicrt_isless_float(float x, float y);
#define isless(x, y) (sizeof((x) + (y)) == sizeof(float) ? minicrt_isless_float((float)(x), (float)(y)) : minicrt_isless_double((double)(x), (double)(y)))
#endif

#ifndef islessequal
int minicrt_islessequal_double(double x, double y);
int minicrt_islessequal_float(float x, float y);
#define islessequal(x, y) (sizeof((x) + (y)) == sizeof(float) ? minicrt_islessequal_float((float)(x), (float)(y)) : minicrt_islessequal_double((double)(x), (double)(y)))
#endif

#ifndef isunordered
int minicrt_isunordered_double(double x, double y);
int minicrt_isunordered_float(float x, float y);
#define isunordered(x, y) (sizeof((x) + (y)) == sizeof(float) ? minicrt_isunordered_float((float)(x), (float)(y)) : minicrt_isunordered_double((double)(x), (double)(y)))
#endif

#ifndef matherr
#define matherr minicrt_matherr
#endif
#endif

#ifndef __builtin_nan
double minicrt_nan(void);
#define __builtin_nan(x) minicrt_nan()
#endif

#ifndef __builtin_nanf
float minicrt_nanf(void);
#define __builtin_nanf(x) minicrt_nanf()
#endif
...
#ifndef isnan
#define isnan(x) (sizeof(x) == sizeof(float) ? minicrt_isnan_float((float)(x)) : minicrt_isnan_double((double)(x)))
#endif

#ifndef signbit
#define signbit(x) (sizeof(x) == sizeof(float) ? minicrt_signbit_float((float)(x)) : minicrt_signbit_double((double)(x)))
#endif
...
#ifndef __have_fpu_fabs
#define __ieee754_fabs(x) __fabs(x)
#define __ieee754_fabsf(x) __fabsf(x)
